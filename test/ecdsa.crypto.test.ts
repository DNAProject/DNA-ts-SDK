...
describe('test sign and verify with ECDSAwithSHA256', () => {
    ...
    test('test verify signature generated by Java SDK', () => {
        ...
        const content = 'deviceCode=device79dd02d40eb6422bb1f7924c2a6b06af&nonce=1042961893&dnaid=did:dna:AVRKWDig5TorzjCS5xphjgMnmdsT7KgsGD&timestamp=1535970123';
    ...
    test('tt', () => {
        ...
        '&dnaid=' + req.dnaid + '&timestamp=' + req.timestamp;
