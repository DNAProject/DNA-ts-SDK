...
export class Address {
     ...
     * @param did DNA ID in the form did:dna:AXmQDzzvpEtPkNwBEFsREzApTTDZFW6frD
     */
    static fromDNAid(did: string): Address {
    ...
    /**
     * Deterministicaly generates DNA ID from this public key.
     */
    static generateDNAid(publicKey: PublicKey): string {
        const address = Address.fromPubKey(publicKey);
        const did = 'did:dna:' + address.toBase58();
