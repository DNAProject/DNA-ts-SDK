...
import { DEFAULT_ALGORITHM, DEFAULT_SM2_ID, DNA_BIP44_PATH } from '../consts';
...
export class PrivateKey extends Key {
   ...
   */
     ...
     *
     */
    static generateFromMnemonic(mnemonic: string, derivePath: string = DNA_BIP44_PATH): PrivateKey {
