...
import { TEST_DNA_URL } from '../../consts';
...
export class WebsocketClient {
    ...
    constructor(url = TEST_DNA_URL.SOCKET_URL, debug = false, autoClose = true) {
     ...
     * The result contains DNA and ONG.
    ...
    /**
     * Get allowanece
     * @param asset Asset's type.Only DNA and ONG supported.
